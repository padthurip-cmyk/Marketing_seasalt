// RSS Feed for SeaSalt Pickles Blog (main site)
// Route: /blog/feed.xml → /.netlify/functions/blog-feed
...
function supaGet(path) {
  return new Promise(function(resolve, reject) {
    ...
    var opts = {
      ...
      method: 'GET',
      headers: { 'apikey': SK, 'Authorization': 'Bearer ' + SK, 'Content-Type': 'application/json', 'Accept': 'application/json' },
      timeout: 12000
    };
...
export var handler = async function(event) {
  ...
  try {
    ...
    xml += '  <description>Authentic Andhra pickle recipes, health tips, food stories from SeaSalt Pickles, Hyderabad.</description>\n';
    ...
    return { statusCode: 200, headers: H, body: '<?xml version="1.0" encoding="UTF-8"?>\n<rss version="2.0"><channel><title>SeaSalt Pickles Blog</title><link>' + SITE + '/blog</link><description>Blog</description></channel></rss>' };
  }
};
